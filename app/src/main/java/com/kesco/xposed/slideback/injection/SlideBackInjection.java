...
import com.kesco.adk.sliding.SlideLayoutKt;
import com.kesco.adk.sliding.SlideListener;
import com.kesco.adk.sliding.SlideShadow;
import com.kesco.adk.sliding.SlideState;
...
public class SlideBackInjection implements IXposedHookZygoteInit, IXposedHookLoadPackage, IXposedHookInitPackageResources {
  ...
  public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
    ...
    XposedHelpers.findAndHookMethod("android.app.Activity", lpparam.classLoader, "onPostCreate", Bundle.class, new XC_MethodHook() {
      ...
      protected void afterHookedMethod(MethodHookParam param) throws Throwable {
        ...
        SlideLayoutKt.convertActivityToTranslucent(act);
      }
    });
  }
  ...
  public void handleInitPackageResources(XC_InitPackageResources.InitPackageResourcesParam resparam) throws Throwable {
    ...
    resId = com.kesco.adk.sliding.R.color.start_shadow_color;
    res.setReplacement(resId, modRes.fwd(resId));
    resId = com.kesco.adk.sliding.R.color.center_shadow_color;
    res.setReplacement(resId, modRes.fwd(resId));
    resId = com.kesco.adk.sliding.R.color.end_shadow_color;
    res.setReplacement(resId, modRes.fwd(resId));
    resId = com.kesco.adk.sliding.R.dimen.shadow_width;
    res.setReplacement(resId, modRes.fwd(resId));
    resId = com.kesco.adk.sliding.R.id.slide_view;
    res.setReplacement(resId, modRes.fwd(resId));
  }
  ...
  private void attachToActivity(final Activity act) {
    Slider.INSTANCE.attachToScreen(act, SlideEdge.LEFT, SlideShadow.FULL, new SlideListener() {
      ...
      @Override
      public void onSlide(float v, SlideState slideState) {
        XposedUtil.log("Sliding percent: " + v);
      }
      ...
      public void onSlideFinish() {
        ...
        XposedUtil.log(act.getClass().getSimpleName() + " : Finish");
      }
    });
  }
